...
def remove_stopwords(data):
    stop_words.extend(['thus', 'thereof', 'thence', 'thee', 'therein', 
                    ...
                    # halfway through, we discovered that this approach of documenting what specials TO remove 
                    # is inefficient and stupid. Hence, we are compiling a list of what TO KEEP instead. Then, 
                    # we would check if a word has a dot. If it does, then we remove it if it is not found in the 
                    # TO KEEP list. 
