...
corrections = {'l●sse': 'loss',
    ...
    'diu●rs':'diverse', 
    'i●land':'island',
    'paracous●y':'paracousey', #flagged for correct spelling? paracoussy?
    'indian●':'indian',
    'spaniard●':'spaniard', # lemma singular?
    'wa●re':'ware',
    'turk●':'turk', 
    'k●ng':'king', 
    'portugal●':'portugal', 
    ...
    'good●':'good', 
    's●aine':'spain', 
    's●aves':'slave', #doublecheck 
    'spain●':'spain', 
    'hop●':'hope', 
    'englishm●n':'englishman', 
    'leagues●':'league', 
    'boa●':'boat', 
    ...
    'couns●ll':'counsel', 
    'r●maine':'roman',
    '●laine':'plain', #By looking at early print, could also be slaine
    '●amous':'famous', 
    'gr●ene':'green',
    ...
    'company●':'company', 
    'magog●':'magog', 
    'a●tracan':'astracan', #i hope? Or maybe Astrakhan
    's●iling':'sailing', 
    ...
    'portugall●':'portugal',
    'russ●n':'russian',
    '●orces':'source', # Maybe also forces?
    'h●ngaria':'hungary',
    'tu●ke':'turk',
    'fru●●ion':'fruition',
    'harbo●●':'harbor',
